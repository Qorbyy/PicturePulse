...
@section('content')
    <section class="bg-gray-100  mt-32">
        <div class="container mx-auto px-8 py-12">
            <h2 class="text-3xl flex justify-center font-bold font font-fontutama mb-6"></h2>
            <div class="mt-6">
                <a href="/createalbum"><button type=""
                        class="px-4 py-2 bg-blue-900 text-white rounded hover:bg-purple-700"><i class="bi bi-arrow-up-square">
                            Create New Album</i></button></a>
            </div>
            <!-- Album Grid -->
            <div class="grid grid-cols-1 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-6 mt-5">
                @foreach ($albums as $album)
                    <!-- Sample Album Cards -->
                    <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                        <a href="/detailalbum/{{ $album->id }}">
                            <img src="{{ asset('/assets/' . $album->foto) }}" alt=""
                                class="w-full h-48 object-cover">
                            <div class="p-4">
                                <h3 class="text-xl font-semibold mb-2">{{ $album->nama_album }}</h3>
                                <p class="text-gray-700">{{ $album->deskripsi }}</p>
                            </div>
        ...
        <div class="mb-8 hidden">
            ...
            <form action="#" method="POST" class="max-w-md">
                <div class="mb-4">
                    ...
                    <input type="text" name="editAlbumName" id="editAlbumName"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="editAlbumDescription" id="editAlbumDescription" rows="4"
                        class="mt-1 p-2 block w-full border-gray-300 rounded-md"></textarea>
                </div>
                <div>
                    <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Update
                        Album</button>
                    <button type="button"
                        class="px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400 ml-2">Cancel</button>
                </div>
            </form>
        </div>

        <!-- Delete Album Conf irmation -->
        <div class="mb-8 hidden">
