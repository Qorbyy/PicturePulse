        ...
        <div class="flex flex-wrap items-center justify-between max-w-screen-md p-4 mx-auto">
            ...
            <div class="flex gap-3">
                ...
                <a href="/register"><button
                        class="font-fontutama px-5 py-1 text-white rounded bg-blue-700">Register</button></a>
            </div>
        </div>
    </nav>
    <section class="mt-32">
        <div class="max-w-[364px] bg-white rounded-md shadow-md mx-auto px-6 py-4">
            ...
            <div class="flex flex-col">
                ...
                <button type="submit" class="border font-fontutama py-1 mt-4 text-center text-white rounded-full bg-blue-700">Login</button>
                <h5 class="mx-auto mt-4 text-xs">Belum punya account, silahkan daftar <a href="register.html" class="text-blue-600">disini.!</a></h5>
            </div>
        </form>
        </div>
    </section>
